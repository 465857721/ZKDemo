...
import com.kingsoft.zkdemo.othereffect.OtherEffectActivity;
import com.kingsoft.zkdemo.recylerview.RecylerViewAllActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DemoBean[] arr = {
                ...
                new DemoBean("RecylerView", RecylerViewAllActivity.class),
                new DemoBean("OtherEffect", OtherEffectActivity.class)
        };
