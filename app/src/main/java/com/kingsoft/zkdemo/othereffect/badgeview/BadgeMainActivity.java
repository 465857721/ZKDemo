package com.kingsoft.zkdemo.othereffect.badgeview;
...
public class BadgeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_badgemain);
        initView();
        initListener();
        initBadge();
    ...
    private void selectorColor(final OnColorClickListener l) {
        ...
        gv.setAdapter(new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                View v = new View(BadgeMainActivity.this);
                ...
                WindowManager wm = (WindowManager) BadgeMainActivity.this
